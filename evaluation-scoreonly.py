...
def func_return_scores_one(modelname=None, dataset_candidates='affectgpt'):
    ...
    for dataset in process_datasets:
        ...
        ## 计算指标
        score1, score2, score3 = main_zeroshot_scores(process_root, debug=False, test_epochs='', inter_print=True)
...
if __name__ == "__main__":
    ...
    #                 ]:
    #     for dataset in ["mer2023", "mer2024", "meld", "iemocapfour", "cmumosi", "cmumosei", "sims", "simsv2"]:
